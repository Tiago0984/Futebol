...
.mat-section h3 .fa { margin-right: 8px; }
...
.alert-err ul { margin: 6px 0 0; padding-left: 18px; font-size: 13px; }
...
.whatsapp-box p { margin: 0 0 8px; font-size: 13px; color: #2e7d32; font-weight: 600; }
.whatsapp-box a {
    display: inline-block;
    background: #25d366;
    color: #fff;
...
@media (max-width: 767px) {
    .mat-section { padding: 20px 15px; }
    .mat-col { margin-bottom: 0; }
}
</style>
