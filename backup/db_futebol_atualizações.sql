...
ADD COLUMN data_jogo datetime NULL;

-- Popula datas dos jogos já existentes
UPDATE tbl_jogos
SET
    data_jogo = '2025-06-01 19:00:00'
WHERE
    id_jogo = 1;

UPDATE tbl_jogos
SET
    data_jogo = '2025-06-06 19:00:00'
WHERE
    id_jogo = 2;
...
VALUES
    (
        'BEM VINDO AO PRO SOCCER',
        'Descrição do banner 1',
        'banner1.jpg',
        1
    ),
    (
        'SOMOS UM CLUBE PROFISSIONAL DE FUTEBOL',
        'Descrição do banner 2',
        'banner2.jpg',
        2
    ),
    (
        'SOMOS O CLUBE DOS SONHOS',
        'Descrição do banner 3',
        'banner3.jpg',
        3
    );
...
VALUES
    (
        'SUB-15 GOLEIA NA ESTREIA DA COPA BASE REGIONAL COM SHOW TÁTICO',
        'Nossa categoria de base sub-15 entrou em campo na manhã deste sábado e aplicou um placar elástico de 4 a 0 contra o rival. O destaque da partida foi o coletivo e a forte pressão na saída de bola, o que garantiu os primeiros 3 pontos na tabela...',
        'sub15_goleada.jpg',
        'Campeonatos',
        '2026-05-28 09:00:00',
        'Prof. Fábio'
    ...
    (
        'Dicas de nutrição para jovens atletas antes de competições',
        'Manter uma alimentação balanceada e rica em carboidratos complexos nos dias que antecedem o confronto é vital para o rendimento tático e vigor físico dos nossos atletas da base.',
        'nutricao_base.jpg',
        'Nutrição & Saúde',
        '2026-05-25 14:20:00',
        'Nutricionista Julia'
    ...
    (
        'Galeria de fotos: Álbum completo do torneio de integração interna',
        'Confira os melhores cliques e momentos marcantes do nosso último torneio interno que reuniu familiares, atletas e toda a comissão técnica em um dia de celebração esportiva.',
        'galeria_torneio.jpg',
        'Treinamentos',
        '2026-05-20 11:15:00',
        'Admin'
    ...
    (
        'Reforma do gramado sintético da quadra central é concluída',
        'O departamento de infraestrutura finalizou a manutenção preventiva e aplicação de novos compostos amortecedores no nosso complexo sintético, elevando a segurança dos treinos diários.',
        'reforma_quadra.jpg',
        'Avisos Oficiais',
        '2026-05-15 16:00:00',
        'Diretoria Executiva'
...
ALTER TABLE `tbl_atletas` MODIFY COLUMN `status_atleta` VARCHAR(20) NOT NULL DEFAULT 'PENDENTE';
...
ALTER TABLE `tbl_atletas` MODIFY COLUMN `numero_atleta` VARCHAR(20) NULL,
...
ALTER TABLE `tbl_responsavel` MODIFY COLUMN `assinatura_responsavel` TEXT NULL,
MODIFY COLUMN `telefone_responsavel` VARCHAR(20) NULL;

-- ============================================================
-- ============================================================
-- Atualização: nova coluna posicao_atleta em tbl_atletas
-- Permite registrar a posição do atleta diretamente no cadastro
-- sem depender do pivot tbl_atleta_time
-- 2026-06-09
-- ============================================================
-- 11. Adiciona posição do atleta (Goleiro, Zagueiro, Lateral, Volante, Meia, Atacante)
ALTER TABLE `tbl_atletas`
ADD COLUMN `posicao_atleta` VARCHAR(50) NULL AFTER `numero_atleta`;

-- ============================================================
-- Atualização: nova coluna telefone_atleta em tbl_atletas
-- Permite registrar o telefone/celular de contato do próprio atleta
-- 2026-06-09
-- ============================================================
-- 12. Adiciona telefone de contato do atleta
ALTER TABLE `tbl_atletas`
ADD COLUMN `telefone_atleta` VARCHAR(20) NULL AFTER `posicao_atleta`;

-- ===========================================================
-- Inserts da tabela galeria (fotos de eventos, treinos, jogos)
INSERT INTO
    `tbl_galeria` (
        `titulo_galeria`,
        `foto_galeria`,
...
VALUES
    ('Foto 1', 'foto1.jpg', 1, 'ATIVO'),
    ('Foto 2', 'foto2.jpg', 2, 'ATIVO'),
    ('Foto 3', 'foto3.jpg', 3, 'ATIVO'),
    ('Foto 4', 'foto4.jpg', 4, 'ATIVO'),
    ('Foto 5', 'foto5.jpg', 5, 'ATIVO'),
