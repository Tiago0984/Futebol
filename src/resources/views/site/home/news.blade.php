				...
				<div class="col-sm-12 col-md-4">
					<div class="blog-item">
						<div class="gambar">
							...
							<img src="{{asset('futebol/images/news/banner1-noticia.jpg')}}" alt="" class="img-responsive" />
						</div>
						<div class="item-body">
				...
				<div class="col-sm-12 col-md-4">
					<div class="blog-item">
						<div class="gambar">
							...
							<img src="{{asset('futebol/images/news/banner2-noticia.jpg')}}" alt="" class="img-responsive" />
						</div>
						<div class="item-body">
							<div class="description">
								<p class="lead">
				...
				<div class="col-sm-12 col-md-4">
					<div class="blog-item">
						<div class="gambar">
							...
							<img src="{{asset('futebol/images/news/banner3-noticia.jpg')}}" alt="" class="img-responsive" />
						</div>
						<div class="item-body">
							<div class="description">
								<p class="lead">
