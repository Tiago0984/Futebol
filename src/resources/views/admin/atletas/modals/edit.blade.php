                ...
                <div class="modal-body px-4" style="max-height:65vh;overflow-y:auto;">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="telefone_atleta" id="edit_telefone" class="form-control" placeholder="(11) 99999-9999" maxlength="20">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label font-weight-bold text-dark">Sala</label>
                            <input type="text" name="sala_atleta" id="edit_sala" class="form-control" placeholder="Ex: Sala 3">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label font-weight-bold text-dark">E-mail</label>
                            <input type="email" name="email_atleta" id="edit_email" class="form-control" placeholder="email@exemplo.com">
                        </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="cep_endereco" id="edit_cep" class="form-control" placeholder="00000-000" maxlength="9">
                        </div>
                        <div class="col-md-5">
                            <label class="form-label font-weight-bold text-dark">Cidade</label>
                            <input type="text" name="cidade_endereco" id="edit_cidade" class="form-control" placeholder="São Paulo">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label font-weight-bold text-dark">Estado (UF)</label>
                            <input type="text" name="estado_endereco" id="edit_estado" class="form-control" placeholder="SP" maxlength="2">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label font-weight-bold text-dark">Rua</label>
                            <input type="text" name="rua_endereco" id="edit_rua" class="form-control" placeholder="Nome da rua">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label font-weight-bold text-dark">Número</label>
                            <input type="text" name="numero_endereco" id="edit_numero_end" class="form-control" placeholder="123">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label font-weight-bold text-dark">Bairro</label>
                            <input type="text" name="bairro_endereco" id="edit_bairro" class="form-control" placeholder="Nome do bairro">
                        </div>

                        <div class="col-md-12">
                            <label class="form-label font-weight-bold text-dark">Complemento</label>
                            <input type="text" name="complemento_endereco" id="edit_complemento" class="form-control" placeholder="Apto, bloco... (opcional)">
                        </div>
                    </div>
